 ...
 */
public class UCPlayerCounterTile extends TileEntity implements IUCTile {
    ...
    public UCTileDefinition getTileDefinition() throws Exception {
        ...
        int entitiesCount = worldObj.getEntitiesWithinAABB(EntityPlayer.class, box).size();
        return new UCPlayerCounterDefinition(entitiesCount);
    }
